...
const SignIn: React.FC = () => {
  ...
  return (
    <div className="lg:max-w-6xl xl:max-w-7xl mx-auto">
      <Breadcrumb title="Sign In" className="mx-4 sm:mx-2 xl:max-w-7xl" />
      ...
      <Card>
        ...
        <div className="flex-1 border-stroke dark:border-strokedark lg:w-1/2 lg:border-l-2">
            ...
            <form onSubmit={handleSubmit(onLogin)}>
              <div className="mb-4">
                <Input
                  ...
                  errorMessage={t('loginForm.errors.email.required')}
              ...
              <div className="mb-6">
                <Input
                  ...
                  errorMessage={t('loginForm.errors.password.required')}
              ...
              {errors.root?.serverError.type === 404 && (
                <p className="text-danger text-sm mb-5">{t('loginForm.errors.root.invalid')}</p>
              )}
