...
const SignUp: React.FC = () => {
  ...
  const { control, handleSubmit, getValues } = useForm<ISignupFormData>({
    mode: 'onChange'
  });
  ...
  return (
    <div className="lg:max-w-6xl xl:max-w-7xl mx-auto">
      <Breadcrumb title="Sign Up" className="mx-4 sm:mx-2 xl:max-w-7xl" />
      ...
      <Card>
        ...
        <div className="w-full border-stroke dark:border-strokedark lg:w-1/2 lg:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            <span className="mb-1.5 block font-medium">{t('signupForm.subtitle')}</span>
            ...
            <form onSubmit={handleSubmit(onSignup)}>
                ...
                {/* <Controller
                    ...
                    render={({ field, fieldState: { invalid } }) => (
                      <Input
                        {...field}
                        hasError={invalid}
                        errorMessage={t('signupForm.errors.name.required')}
                        label={t('signupForm.name')}
                        placeholder="Enter your full name"
                        rIcon={<User size={22} className="text-gray-400" />}
                      />
                    )}
                  /> */}
                <Input
              ...
              <div className="mb-4">
                <Select
                  ...
                  name="schoolId"
                  defaultValue=""
                  errorMessage={t('signupForm.errors.school.required')}
                  label={t('signupForm.school')}
              ...
              <div className="mb-4">
                <Input
                  ...
                  name="email"
                  errorMessage={t('signupForm.errors.email.required')}
                  label={t('signupForm.email')}
                  placeholder="Enter your email"
                  rIcon={<Mail size={22} className="text-gray-400" />}
                />
              </div>
              ...
              <div className="mb-4">
                <Input
                  ...
                  name="password"
                  htmlType="password"
                  errorMessage={t('signupForm.errors.password.required')}
                  label={t('signupForm.password')}
                  placeholder="Enter your password"
                  rIcon={<Lock size={22} className="text-gray-400" />}
                />
              </div>
              ...
              <div className="mb-6">
                <Input
                  ...
                  htmlType="password"
                  errorMessage={t('signupForm.errors.password.shouldMatch')}
